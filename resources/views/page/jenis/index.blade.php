                ...
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="modal-body">
                                        <form action="/material-type/store" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="tipe" id=""
                                                    ...
                                                    <div class="modal fade" id="updateModal" tabindex="-1" role="dialog"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form action="/jenis-bahan/{{ $jenis->id }}/update"
                                                                        method="post">
                                                                        @csrf
                                                                        <div class="mb-3">
                                                                            <label for=""
                                                                                class="form-label">Tipe</label>
                                                                            <input value="{{ $jenis->tipe }}" type="text"
                        ...
                        <button class="btn btn-danger"
                            onclick="Delete('/material-type/{{ $jenis->id }}/hapus')">Hapus</button>
                    @endcan
                    </td>
                    </tr>
                    </tbody>
