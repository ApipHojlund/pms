                    ...
                    <div class="card-body">
                        ...
                        <form action="/order/store" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="nama_model" id=""
                                    aria-describedby="helpId" placeholder="" />
                                <input type="file" class="form-control" name="model" id="" placeholder=""
                                    aria-describedby="fileHelpId" />
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Production quantity</label>
                                <input type="number" class="form-control" name="jumlah" id="" placeholder="" />
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Weight Material Required</label>
                                <input type="number" class="form-control" name="berat" id="" placeholder="" />
                            </div>
                            <div class="mb-3">
