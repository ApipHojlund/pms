...
const formContainerLogin = document.querySelector(".form-container:last-child"); // Target first form container
const formContainerRegister = document.querySelector(".form-container:first-child"); // Target second form container
...
// Initial state: Register form visible
toggleForm("register");
